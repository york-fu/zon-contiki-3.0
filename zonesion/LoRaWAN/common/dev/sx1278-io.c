...
void (*EXTI4_Call[1])(void) = {NULL};
void (*EXTI3_Call[1])(void) = {NULL};

void EXTI4_CallSet(void (*func)(void))
{
  EXTI4_Call[0] = func;
}
void EXTI3_CallSet(void (*func)(void))
{
  EXTI3_Call[0] = func;
}
/*
